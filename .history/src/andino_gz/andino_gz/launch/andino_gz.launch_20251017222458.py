...
def generate_launch_description():
    ...
    # ---------------- Static TF (single root) ----------------
    # Make Gazebo's global frame coincide with Nav2's map frame.
    ...
    for robot_name in robots_list:
        ...
        nav_group = GroupAction(
            ...
            actions=[
                ...
                # --- robot_localization EKF: publishes odom -> base_link from /odom and /imu/data ---
                Node(
    ...
    # Static TF fix (ONLY gazebo_world -> map)
