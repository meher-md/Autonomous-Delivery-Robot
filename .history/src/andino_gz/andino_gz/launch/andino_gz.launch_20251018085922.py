...
def generate_launch_description():
    ...
    params_file_arg = DeclareLaunchArgument(
        ...
        description='Nav2 configuration (applies to all Nav2 nodes).'
    )
    ...
    # ---------------- TF ثابت: خليه map = world (Nav2 بيتوقع كده)
    ...
    # مفيش robot_localization هنا نهائيًا
    ...
    for robot_name in robots_list:
        ...
        robots_group = GroupAction(
            ...
            actions=[
                ...
                # Robot State Publisher (TF للروابط)
                Node(
                ...
                TimerAction(
                    ...
                    actions=[
                        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'map': map_yaml_path,         # <- الـ YAML الكامل
                                'autostart': 'True',
                                'use_sim_time': 'True',
