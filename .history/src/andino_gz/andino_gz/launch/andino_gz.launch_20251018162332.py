...
def generate_launch_description():
    ...
    base_group = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                # Correct bidirectional mapping (gz.msgs in Humble)
    ...
    # ---------------- Static TF (root glue + provisional map->odom) ----------------
    static_tf_world_to_gz = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='tf_world_to_gazebo_world',
        arguments=['0', '0', '0', '0', '0', '0', 'world', 'gazebo_world'],
        output='screen'
    )
    ...
    for robot_name in robots_list:
        ...
        # EKF node per robot to publish odom -> base_link (expects /odom from bridge or Gazebo)
        ekf_node = Node(
            ...
            parameters=[{
                ...
                'twist0_rejection_threshold': 5.0,
            }]
        )
    ...
    # Static TF nodes
    ld.add_action(static_tf_world_to_gz)
