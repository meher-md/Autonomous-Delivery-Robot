...
def generate_launch_description():
    ...
    # لِـ initialpose التلقائي: خُد أول روبوت كمرجع
    ...
    for robot_name, init_pose in robots_list.items():
        robots_group = GroupAction(
            actions=[
                ...
                IncludeLaunchDescription(  # spawn
                ...
                # RViz (Fixed Frame = odom لضمان التطابق الفوري مع جازيبوا)
                TimerAction(
                    period=5.0,
                    actions=[
                        Node(
                            ...
                            arguments=['-f','odom','-d', os.path.join(pkg_andino_gz,'rviz','andino_gz_nav2.rviz')],
                ...
                IncludeLaunchDescription(  # robot bridges
        ...
        nav_group = GroupAction(
            actions=[
                ...
                IncludeLaunchDescription(  # Nav2 bringup
