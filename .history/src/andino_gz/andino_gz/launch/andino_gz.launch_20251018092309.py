...
def generate_launch_description():
    ...
    # ---------------- Static TF: make "world" (Gazebo) coincide with "map" ----------------
    # DO NOT create any static TF for odom. odom->base_link must come from the robot (Gazebo).
    ...
    for a in (ros_bridge_arg, rviz_arg, world_name_arg, robots_arg, gui_config_arg,
              nav2_arg, map_name_arg, params_file_arg, auto_initpose_arg):
        ld.add_action(a)
