...
def generate_launch_description():
    ...
    # ----------------- Auto align (from YAML origin) -----------------
    # نحسب:
    #   static TF: gazebo_world -> map = (-ox, -oy, -oyaw)
    #   /initialpose (map) = (spawn - origin)
...
n.get_logger().info(f"world->map set to (-{ox:.3f}, -{oy:.3f}, yaw {-oyaw:.3f})")
