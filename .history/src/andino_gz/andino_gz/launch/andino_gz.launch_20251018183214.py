...
def generate_launch_description():
    ...
    # IMPORTANT:
    # We must NOT create a world <-> odom loop. Provide exactly ONE static transform
    # that makes 'odom' a child of the chosen world-like frame (gazebo_world by default).
    # This unifies the tree: map -> odom -> ... -> base_link (AMCL provides map->odom).
    static_tf_world_to_odom = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='tf_world_to_odom',
        # parent = tf_world_parent, child = odom
