...
def generate_launch_description():
    ...
    # ----------------- Initial Pose only (no static TF) -----------------
    # ننتظر map_server و amcl يصبحان active ثم ننشر /initialpose في إطار map
