...
def generate_launch_description():
    ...
    static_tf_gz = Node(
        package='tf2_ros', executable='static_transform_publisher', name='tf_gazebo_world_to_odom',
        arguments=['0', '0', '0', '0', '0', '0', 'gazebo_world', 'odom'], output='screen'
    )
    ...
    for robot_name in robots_list:
        ...
        robots_group = GroupAction(
            ...
            actions=[
                ...
                # RViz with Nav2 (delay + software rendering)
                TimerAction(
                    period=5.0,
                    actions=[
                        Node(
    ...
    # ---------------- Auto initial pose (multiline script) ----------------
...
'''
    ...
    # ---------------- Clear costmaps (multiline script) ----------------
    clear_costmaps_script = r'''
import rclpy
from rclpy.node import Node
from std_srvs.srv import Empty

def call_once(node: Node, name: str):
