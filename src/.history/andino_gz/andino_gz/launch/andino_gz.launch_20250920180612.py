...
def generate_launch_description():
    ...
    # NEW: expose ultrasonic arg
    use_ultrasonic_arg = DeclareLaunchArgument(
        'use_ultrasonic', default_value='True', description='Enable/disable ultrasonic sensor in xacro.')
    ...
    use_ultrasonic = LaunchConfiguration('use_ultrasonic')  # NEW
    ...
    # Base group: Gazebo sim + generic bridge
    ...
    for robot_name in robots_list:
        ...
        robots_group = GroupAction(
            ...
            actions=[
                ...
                # Spawn robot (pass ultrasonic arg through)
                IncludeLaunchDescription(
                    PythonLaunchDescriptionSource(
                    ...
                    launch_arguments={
                        ...
                        'use_sim_time': 'true',
                        # NEW: forward ultrasonic arg to spawn file
    ...
    ld.add_action(use_ultrasonic_arg)  # NEW
